...
<script>
    ...
    function drawTable(data) {
        ...
        $.each(data, function(key, value) {
            ...
            for (var i = 0; i < value.length; i++) {
                drawRow(value,i);
                gr_qty += parseFloat(value[i].RequestQty);
                gr_net += parseFloat(value[i].RequestQty) * parseFloat(value[i].CostPrice);
                gr_cost += parseFloat(value[i].CostPrice);

                totalStock+=(parseFloat(value[i].RequestQty));
                totalCostValue+=(parseFloat(value[i].CostPrice));
                totalValue+=(parseFloat(value[i].RequestQty) * parseFloat(value[i].CostPrice));
                totalProfit+=(parseFloat(value[i].RequestQty) * parseFloat(value[i].CostPrice));
                ...
                if (i == (value.length - 1)) {
                    $("#saletable").append("<tr style='background-color:#A9A9A9;color:#fff;'><td colspan='3' >Total</td><td>" + accounting.formatMoney(gr_qty) + "</td><td>" + accounting.formatMoney(gr_cost) + "</td><td class='cos'></td><td><b>" + accounting.formatMoney(gr_net) + "</b></td><td><b></b></td><td><b></b></td></tr>");
    ...
    function drawRow(rowData,index) {
        ...
        row.append($("<td>" + rowData[index].ProName + "</td>"));
        row.append($("<td>" + rowData[index].RequestQty + "</td>"));
        row.append($("<td>" + rowData[index].CostPrice + "</td>"));
        row.append($("<td>" + accounting.formatMoney(parseFloat(rowData[index].RequestQty) * parseFloat(rowData[index].CostPrice)) + "</td>"));
        row.append($("<td>" + accounting.formatMoney(parseFloat(rowData[index].RequestQty) * parseFloat(rowData[index].CostPrice)) + "</td>"));
