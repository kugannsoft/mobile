...
<!--                        <th id="totalnbta" style="text-align: right;color: #00aaf1;"></th>-->
                        <th><b>Total</b></th>
                        <th id="totalqty" style="text-align: right;color: #00aaf1;">
...
<!--                        <td></td>-->
                        ...
                        <td id="totalDue" style="color:#f00;font-weight:bold" colspan="1"></td>
                    </tr>
                    </tfoot>
                </table>
            </div>
...
<script>
    ...
    $('#filterform').submit(function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: "loadreportdirectdepartmentby",
            data: $(this).serialize(),
            success: function (data) {
                $('#saletable tbody').empty();
                drawTable(JSON.parse(data));
                $('#totalqty').html(accounting.formatMoney(sumcolumn('Qty')));
    ...
    function drawRow(rowData) {
        ...
        row.append($("<td><a href='<?php echo base_url() ?>admin/payment/view_customer/" + (rowData.DepName) +"' >" + " "+rowData.DepName+ "</a></td>"));
